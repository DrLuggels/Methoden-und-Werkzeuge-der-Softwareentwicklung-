...
werden. Das widerspricht dem Least-Privilege-Prinzip~\cite{saltzer}, vergrößert
...
das Ports-and-Adapters-Muster~\cite{cockburn} unabhängig vom Trägersystem.
...
Die Analyse folgt STRIDE~\cite{shostack} und ordnet jeder Bedrohung eine
...
\bibitem{saltzer} J.~H. Saltzer und M.~D. Schroeder, ``The Protection of
Information in Computer Systems,'' \emph{Proceedings of the IEEE}, Bd.~63,
Nr.~9, S.~1278--1308, 1975.

\bibitem{vault} HashiCorp, ``Vault SSH Secrets Engine,'' HashiCorp
Documentation. [Online]. Verfügbar:
\texttt{https://developer.hashicorp.com/vault/docs/secrets/ssh}

\bibitem{boundary} HashiCorp, ``Boundary,'' Produktdokumentation. [Online].
Verfügbar: \texttt{https://www.boundaryproject.io}

\bibitem{teleport} Teleport, ``Teleport Access Platform,''
Produktdokumentation. [Online]. Verfügbar: \texttt{https://goteleport.com}

\bibitem{keycloak} Red Hat, ``Keycloak -- Open Source Identity and Access
Management,'' Produktdokumentation. [Online]. Verfügbar:
\texttt{https://www.keycloak.org}

\bibitem{cockburn} A.~Cockburn, ``Hexagonal Architecture (Ports and
Adapters),'' 2005. [Online]. Verfügbar:
\texttt{https://alistair.cockburn.us/hexagonal-architecture/}

\bibitem{fips180} National Institute of Standards and Technology, ``Secure Hash
Standard (SHS),'' FIPS PUB 180-4, 2015.

\bibitem{shostack} A.~Shostack, \emph{Threat Modeling: Designing for Security}.
Indianapolis, IN: Wiley, 2014.

\bibitem{nistgcm} M.~Dworkin, ``Recommendation for Block Cipher Modes of
Operation: Galois/Counter Mode (GCM) and GMAC,'' NIST Special Publication
800-38D, 2007.

\bibitem{rfc6238} D.~M'Raihi, S.~Machani, M.~Pei und J.~Rydell, ``TOTP:
Time-Based One-Time Password Algorithm,'' RFC~6238, IETF, 2011.

\bibitem{rfc4226} D.~M'Raihi, M.~Bellare, F.~Hoornaert, D.~Naccache und
O.~Ranen, ``HOTP: An HMAC-Based One-Time Password Algorithm,'' RFC~4226, IETF,
2005.

\bibitem{webauthn} World Wide Web Consortium (W3C), ``Web Authentication: An API
for Accessing Public Key Credentials Level~2,'' W3C Recommendation, 2021.
