"""Ziffern-Klassifikator (MNIST, Ziffern 1-9). Laedt das trainierte
scikit-learn-Pipeline-Modell und liefert Vorhersage + Konfidenz.
Entspricht dem Kursskript (Block 4).
"""
import os
...
_pipeline = joblib.load(os.getenv("MODEL_PATH", "models/digit_classifier_v1.pkl"))
