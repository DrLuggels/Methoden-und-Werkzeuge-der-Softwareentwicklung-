...
\begin{titlepage}
  ...
  \vspace{0.6cm}
  {\small Quellcode:
   \url{https://github.com/DrLuggels/Methoden-und-Werkzeuge-der-Softwareentwicklung-}\\[0.3em]
   Abgabe-Tag: \texttt{v1.0}\par}
\end{titlepage}
...
\texttt{module.go}) und drei Adaptern: einem In-Memory-Store, einem
dateibasierten Store (JSON-Persistenz, atomar per Temp-Datei und Rename) und
einem TOTP-Verifier nach RFC~6238. Der Kern hat keine externen Abhängigkeiten.
...
(\texttt{go test -race}); die Abdeckung beträgt rund 81\,\% im Kern und 91\,\% im
